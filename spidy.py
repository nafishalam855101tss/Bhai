...
def handle_bgmi(message):
 ...
 🛒 𝑫𝑴 𝑯𝑬𝑹𝑬 𝑻𝑶 𝑩𝑼𝒀 𝑨𝑪𝑪𝑬𝑺𝑺 :- @DDOS_SELLER_1"""
...
🚀 𝑩𝑼𝒀 𝑯𝑬𝑹𝑬:- @DDOS_SELLER_1
🚀 𝑶𝑭𝑭𝑰𝑪𝑰𝑨𝑳 𝑪𝑯𝑨𝑵𝑵𝑬𝑳:- @DDOS_SELLER_12
'''
...
def welcome_start(message):
    ...
    response = f'''𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑫𝑫𝒐𝑺 𝑩𝑶𝑻:- @DDOS_SELLER_1
